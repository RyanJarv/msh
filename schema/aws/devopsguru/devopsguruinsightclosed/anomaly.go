...
type Anomaly struct {
    ...
    CloseTimeISO string `json:"closeTimeISO,omitempty"`
...
func (a *Anomaly) SetEndTimeISO(endTimeISO string) {
    a.EndTimeISO = endTimeISO
}
...
func (a *Anomaly) SetCloseTime(closeTime string) {
    a.CloseTime = closeTime
}

func (a *Anomaly) SetCloseTimeISO(closeTimeISO string) {
    a.CloseTimeISO = closeTimeISO
}
