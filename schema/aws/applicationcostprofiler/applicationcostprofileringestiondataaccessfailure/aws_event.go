...
type AWSEvent struct {
    Detail ApplicationCostProfilerIngestionDataAccessFailure `json:"detail"`
...
func (a *AWSEvent) SetDetail(detail ApplicationCostProfilerIngestionDataAccessFailure) {
    a.Detail = detail
}
