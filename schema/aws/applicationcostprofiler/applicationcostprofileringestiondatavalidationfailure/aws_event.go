...
type AWSEvent struct {
    Detail ApplicationCostProfilerIngestionDataValidationFailure `json:"detail"`
...
func (a *AWSEvent) SetDetail(detail ApplicationCostProfilerIngestionDataValidationFailure) {
    a.Detail = detail
}
