package applicationcostprofilerreportgenerated
...
type AWSEvent struct {
    Detail ApplicationCostProfilerReportGenerated `json:"detail"`
...
func (a *AWSEvent) SetDetail(detail ApplicationCostProfilerReportGenerated) {
    a.Detail = detail
}
