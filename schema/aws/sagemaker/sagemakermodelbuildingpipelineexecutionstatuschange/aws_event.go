...
type AWSEvent struct {
    Detail SageMakerModelBuildingPipelineExecutionStatusChange `json:"detail"`
...
func (a *AWSEvent) SetDetail(detail SageMakerModelBuildingPipelineExecutionStatusChange) {
    a.Detail = detail
}
