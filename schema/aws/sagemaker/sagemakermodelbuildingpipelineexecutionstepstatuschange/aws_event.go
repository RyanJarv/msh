...
type AWSEvent struct {
    Detail SageMakerModelBuildingPipelineExecutionStepStatusChange `json:"detail"`
...
func (a *AWSEvent) SetDetail(detail SageMakerModelBuildingPipelineExecutionStepStatusChange) {
    a.Detail = detail
}
