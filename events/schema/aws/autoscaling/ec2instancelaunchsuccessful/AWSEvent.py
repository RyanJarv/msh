...
from schema.aws.autoscaling.ec2instancelaunchsuccessful.EC2InstanceLaunchSuccessful import EC2InstanceLaunchSuccessful  # noqa: F401,E501

class AWSEvent(object):


    _types = {
        'detail': 'EC2InstanceLaunchSuccessful',
        'detail_type': 'str',
        'resources': 'list[str]',
        'id': 'str',
        'source': 'str',
